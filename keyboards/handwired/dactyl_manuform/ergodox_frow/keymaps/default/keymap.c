...
[_QWERTY] = LAYOUT_ergodox_frow(
  // left hand
   KC_HOME,   KC_F1,   KC_F2,   KC_F3,  KC_F4,  KC_F5,  KC_F6,
   ...
   KC_CAPS,   KC_LGUI, TAB_L,   TAB_R,
                               ...
                               KC_GRV, TASK,
        // right hand
                     KC_F7,   KC_F8,   KC_F9,   KC_F10,   KC_F11,   KC_F12,   KC_END,
...
[_FN] = LAYOUT_ergodox_frow(
  // left hand
   RESET,     _______,   _______,   _______,   _______,   _______,  _______,
   _______,   KC_F1,     KC_F2,      KC_F3,    KC_F4,     KC_F5,    KC_F6,
   _______,   RGB_SAI,   RGB_SAD,    KC_UP,    _______,   _______,  _______,
   _______,   RGB_MOD,   KC_LEFT,    KC_DOWN,  KC_RGHT,   RGB_RMOD,  RESET,
   _______,   RGB_HUI,   RGB_HUD,   RGB_VAI,   RGB_VAD,   _______,
