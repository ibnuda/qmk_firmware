...
[_ADJUST] = LAYOUT(
    ...
    _______,CLSGUI, _______,CONPST, RESET,  LOWER,  RAISE,  _______,_______,_______,_______,_______,
                    _______,_______,_______,                _______,_______,_______
),
[_MOVMNT] = LAYOUT(
    _______,_______,_______,_______,_______,                _______,KC_PGUP,KC_HOME,_______,_______,
    _______,_______,_______,_______,_______,                KC_LEFT,KC_DOWN,KC_UP,  KC_RGHT,_______,
    _______,_______,_______,_______,_______,LOWER,  RAISE,  _______,KC_PGDN,KC_ENT, _______,_______,
                    _______,_______,_______,                _______,_______,_______
),
};
